  ...
  rules: {
    ...
    'no-magic-numbers': [
      'off',
      {
        ...
        ignore: [0, 1, 2, 3, 200, 400, 401, 403, 404, 405, 500],
      },
    ], // 禁止使用魔术数字, 暂时关闭
    ...
    'object-curly-spacing': [
      ...
      'always',
      {
        // 强制在花括号中使用一致的空格 always要求花括号内有空格 (除了 {})
    ...
    // 其他规则：
    'vue/block-lang': [
      'error', // 此规则不允许将您的应用程序中可用的语言以外的语言用于块元素的 lang 属性
      {
        script: {
          lang: ['js', 'ts'],
        },
    ...
    'vue/component-api-style': [
      'error', // 此规则旨在使您用于定义 Vue 组件的 API 样式在您的项目中保持一致
    ...
    'vue/component-name-in-template-casing': [
      ...
      'PascalCase',
      {
        // 此规则旨在警告 Vue.js 模板中配置的大小写以外的标记名称。
